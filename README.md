...
```javascript
import snakecase from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-snakecase@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/string-snakecase/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/string-snakecase/actions/workflows/test.yml?query=branch:v0.1.1
